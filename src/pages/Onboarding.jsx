...
import {
  ...
  INVESTMENT_TRIGGER_CATEGORY_IDS,
  INVESTMENT_YEARS_OPTIONS,
  computeInvestmentProfileStrength,
  normalizeInvestmentDraft,
} from '../lib/investmentProfile';

// Helper: compress all images in a file input event, return array of compressed data URLs
async function readAndCompressFiles(files, maxDim = 1024, quality = 0.78) {
...
function Chip({ active, onClick, children, style, ...buttonProps }) {
  return (
    <button
      type="button"
      onClick={onClick}
