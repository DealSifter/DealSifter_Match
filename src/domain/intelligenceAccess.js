...
export function inferRequestedIntelligenceReportType(message, { explicitReportType = '', hasPropertyContext = false } = {}) {
  ...
  if (/\b(full deal intelligence|deal intelligence|analyze this property deeply|analyze this deal(?: deeply)?|is this property worth looking at|what are the risks|explain this arv|calculate (?:the )?arv|deep analysis|analise (?:este |esse )?deal|vale a pena analisar (?:este |esse )?imovel|quais (?:sao )?os riscos|explique (?:este |o )?arv|calcule (?:este |o )?arv|analise completa|analise profunda|inteligencia completa|inteligencia do deal|analisis (?:este )?deal|vale la pena revisar esta propiedad|cuales son los riesgos|explica este arv|calcula (?:este |el )?arv|analisis completo|analisis profundo)\b/.test(text)) {
