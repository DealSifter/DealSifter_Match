...
export function ProfessionalPropertyForm({
  t,
  C,
  values,
  onChange,
  ...
  return (
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(170px, 0.95fr) minmax(0, 2.75fr)', gap: 6, marginBottom: 8, width: '100%', minWidth: 0 }}>
        <div style={{ position: 'relative', minWidth: 0 }}>
        ...
        <div style={{ position: 'relative', minWidth: 0, display: 'grid', gridTemplateColumns: 'minmax(78px, 0.82fr) minmax(95px, 0.95fr) minmax(78px, 0.82fr)', gap: 6, justifyContent: 'end', alignContent: 'start' }}>
          <div style={{ position: 'relative', minWidth: 0 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(170px, 0.95fr) minmax(0, 2.75fr)', gap: 6, marginBottom: 8, width: '100%', minWidth: 0, alignItems: 'start' }}>
        ...
        {values.portfolioImages.length > 0 && (
          <div style={{ gridColumn: '1 / -1', marginTop: 8, display: 'flex', gap: 6, overflowX: 'auto', paddingBottom: 4 }}>
            {values.portfolioImages.map((src, idx) => (
              <div key={`preview-${idx}`} style={{ position: 'relative', borderRadius: 8, overflow: 'hidden', background: C.alpha(C.t1, 0.02), border: `1px solid ${C.border}`, display: 'flex', alignItems: 'center', justifyContent: 'center', width: 120, height: 72, flex: '0 0 120px' }}>
