...
export const Icon = ({ name, size=18, color="currentColor", strokeWidth=1.5, secondaryColor = null }) => {
  ...
  const icons = {
    ...
    lightbulb:  <svg style={s} viewBox="0 0 24 24"><path {...p} d="M9 18h6"/><path {...p} d="M10 22h4"/><path {...p} d="M8.5 14.5c-1.4-1.1-2.3-2.8-2.3-4.7A5.8 5.8 0 0 1 12 4a5.8 5.8 0 0 1 5.8 5.8c0 1.9-.9 3.6-2.3 4.7-.7.6-1.1 1.2-1.2 2H9.7c-.1-.8-.5-1.4-1.2-2z"/></svg>,
    ...
    grid:       <svg style={s} viewBox="0 0 24 24"><line {...p} x1="4" y1="6" x2="20" y2="6"/><polyline {...p} points="7 3 4 6 7 9"/><polyline {...p} points="17 3 20 6 17 9"/><path {...p} d="M12.2 21c-2.2 0-3.9-1.7-3.9-3.9v-3.5c0-.9.7-1.6 1.6-1.6.6 0 1.1.3 1.4.8V9.1c0-.9.7-1.6 1.6-1.6s1.6.7 1.6 1.6v4.2h.5c1 0 1.8.8 1.8 1.8v1.9c0 2.2-1.8 4-4 4h-.6z"/><line {...p} x1="12.9" y1="10.3" x2="12.9" y2="18.1"/><line {...p} x1="14.7" y1="13.2" x2="14.7" y2="18.1"/></svg>,
    zap:        <svg style={s} viewBox="0 0 24 24"><polygon {...p} points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>,
    spotlight:  <svg style={s} viewBox="0 0 64 64"><path {...p} d="M7 40 10 18c1.1-7.7 8.5-12.6 15.9-10.4L39 11.5 55 8 48 50 34 37 17 34Z"/><path {...p} d="M39 11.5 34 37"/><path {...p} d="M27 4v21"/><circle {...p} cx="27" cy="27" r="6"/><circle {...p} cx="27" cy="27" r="1.8"/><path {...p} d="M56 28h6M54.5 36l5 3.5M54.5 20l5-3.5"/></svg>,
