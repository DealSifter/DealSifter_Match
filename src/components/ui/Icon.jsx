...
export const Icon = ({ name, size=18, color="currentColor", strokeWidth=1.5 }) => {
  ...
  const icons = {
    ...
    grid:       <svg style={s} viewBox="0 0 24 24"><path {...p} d="M3 6h18"/><polyline {...p} points="6 3 3 6 6 9"/><polyline {...p} points="18 3 21 6 18 9"/><path {...p} d="M11.5 21.2c-2 0-3.6-1.6-3.6-3.6v-3.1c0-1 .8-1.8 1.8-1.8.5 0 .9.2 1.2.5V9.4c0-1 .8-1.8 1.8-1.8s1.8.8 1.8 1.8v3h.4c1 0 1.8.8 1.8 1.8v2.5c0 2.5-2 4.5-4.5 4.5h-.7z"/><line {...p} x1="12.7" y1="11.3" x2="12.7" y2="18.2"/><line {...p} x1="14.6" y1="13.1" x2="14.6" y2="18.2"/><circle {...p} cx="9.7" cy="14.7" r="0.2"/></svg>,
