...
export const Icon = ({ name, size=18, color="currentColor", strokeWidth=1.5 }) => {
  ...
  const icons = {
    ...
    grid:       <svg style={s} viewBox="0 0 24 24"><path {...p} d="M4 6h16"/><polyline {...p} points="7 3 4 6 7 9"/><polyline {...p} points="17 3 20 6 17 9"/><path {...p} d="M11.2 21c-1.7 0-3-1.3-3-3v-3.7c0-.9.7-1.6 1.6-1.6.4 0 .7.1 1 .3V9.7c0-.9.7-1.6 1.6-1.6s1.6.7 1.6 1.6v3h.5c.9 0 1.6.7 1.6 1.6v2.2c0 2.5-2 4.5-4.5 4.5h-.4z"/><line {...p} x1="12.4" y1="12.2" x2="12.4" y2="17.8"/></svg>,
