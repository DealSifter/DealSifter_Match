...
export const PLANS = [
  { id:"free",       name:"Basic",        price:0,   nuggets:3,  firstMonthBonus:0,  color:C.t2,    limits:{ swipesPerDay:20, likesPerDay:5, activeMatches:3, unlockRequestsPerMonth:3, profile:"standard" }, features:["3 Gold Nuggets/month","20 swipes/day","5 favorited matches/day","3 active unlocked matches","Standard profile with optional verification"] },
  { id:"pro",        name:"Professional", price:49,  nuggets:20, firstMonthBonus:3,  color:C.accent, limits:{ likesPerDay:null, activeMatches:15, unlockRequestsPerMonth:10, canExportUnlockedPdf:true, hasDealSifterChat:true, featuredProfileDiscountPct:20 }, features:["20 Gold Nuggets/month + 3 first month","Unlimited likes","10 unlocks/month","15 active matches","Export unlocked properties as PDF","DealSifter chat","20% off Featured Profile"], popular:true },
