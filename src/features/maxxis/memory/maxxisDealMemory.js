...
const CHANGE_COPY = Object.freeze({
  en: {
    ...
    forgetBody: 'This only removes the Maxxis continuity snapshot for this deal. It does not delete the deal, workflow, messages, providers, or unlocks.',
    confirm: 'Forget memory',
    cancel: 'Keep memory',
    forgotten: 'The Maxxis continuity snapshot for this deal was removed.',
    nothingToForget: 'There is no Maxxis continuity snapshot to remove for this deal.',
    currentContextRequired: 'Open a deal before asking Maxxis to recall or forget its continuity snapshot.',
  ...
  pt: {
    ...
    forgetBody: 'Isto remove somente o snapshot de continuidade do Maxxis. Nao exclui o deal, workflow, mensagens, providers ou desbloqueios.',
    confirm: 'Esquecer memoria',
    cancel: 'Manter memoria',
    forgotten: 'O snapshot de continuidade do Maxxis para este deal foi removido.',
    nothingToForget: 'Nao existe snapshot de continuidade do Maxxis para remover neste deal.',
    currentContextRequired: 'Abra um deal antes de pedir ao Maxxis para recuperar ou esquecer sua memoria de continuidade.',
  ...
  es: {
    ...
    forgetBody: 'Esto elimina solo el snapshot de continuidad de Maxxis. No elimina el deal, workflow, mensajes, providers ni desbloqueos.',
    confirm: 'Olvidar memoria',
    cancel: 'Conservar memoria',
    forgotten: 'Se elimino el snapshot de continuidad de Maxxis para este deal.',
    nothingToForget: 'No existe un snapshot de continuidad de Maxxis para eliminar en este deal.',
    currentContextRequired: 'Abre un deal antes de pedir a Maxxis que recuerde u olvide su memoria de continuidad.',
