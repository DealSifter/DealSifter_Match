...
The Maxxis Deal AI deal funnel is: property viewed → Deal Copilot opened → provider suggested → unlock started/completed → message sent → provider reply received. Session/auth, profile completion, interest, search, message draft, next action and workflow completion are also defined.
