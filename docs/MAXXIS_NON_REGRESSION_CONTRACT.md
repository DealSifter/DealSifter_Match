# Contrato de não regressão do Maxxis Deal AI

## Finalidade

Este contrato congela a experiência funcional e visual existente no início da Fase 6. As fases 6A–6G podem evoluir a presença contextual do Maxxis Deal AI, mas não recebem autorização implícita para alterar o restante do DealSifter.
...
- componentes próprios do Maxxis Deal AI;
- FAB/avatar, painel, cabeçalho e mensagens do Maxxis Deal AI;
- cards, balões e insights contextuais do Maxxis Deal AI;
- estados de loading, erro e confirmação do Maxxis Deal AI;
- integrações Maxxis Deal AI com Property Context, Deal Copilot, providers e workflow;
- pontos de interação Maxxis Deal AI identificados em `MAXXIS_SURFACE_MAP.md`.
...
- conteúdo ou estado da página sob o overlay do Maxxis Deal AI.
...
## Contratos funcionais do Maxxis Deal AI
...
- Maxxis Deal AI não substitui, intercepta nem mistura seu histórico com o chat humano.
- Maxxis Deal AI não se torna agente autônomo. Ele sugere; o usuário decide e confirma.

## Contrato de animação

Toda animação futura do Maxxis Deal AI deve:
...
Maxxis Deal AI deve ser contextual, útil, discreto, fácil de ignorar, não infantil, não invasivo e não persistentemente irritante. Ele pode sugerir presença; não pode exigir atenção. Não deve reaparecer em loop, perseguir o cursor, interromper digitação, sobrepor CTA crítico ou simular urgência inexistente.
