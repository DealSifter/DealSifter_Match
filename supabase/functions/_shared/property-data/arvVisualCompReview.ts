  ...
  const candidates = input.candidates
    ...
    .map((candidate) => {
      ...
      return {
        ...
        bedrooms: candidate.soldRecord.bedrooms,
        bathrooms: candidate.soldRecord.bathrooms,
        livingAreaSqft: candidate.soldRecord.livingAreaSqft,
        latitude: candidate.soldRecord.latitude,
        longitude: candidate.soldRecord.longitude,
