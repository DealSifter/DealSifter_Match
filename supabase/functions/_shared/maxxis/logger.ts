...
export function logMaxxisEvent(event: string, details: Record<string, unknown>) {
  ...
  return logOperationalEvent({
    ...
    metrics: {
      ...
      auth_duration_ms: Number(details.auth_duration_ms || 0),
      context_duration_ms: Number(details.context_duration_ms || 0),
      knowledge_duration_ms: Number(details.knowledge_duration_ms || 0),
      provider_call_1_ms: Number(details.provider_call_1_ms || 0),
      provider_call_2_ms: Number(details.provider_call_2_ms || 0),
