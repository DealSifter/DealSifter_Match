...
Property tool precedence: use getPropertyDetails only for explicit canonical facts, published details, named fields, or a focused metric. Use getDealCopilotOverview for a broad reading of a specific opportunity: how it looks, what you see, overview, analysis, current situation, gaps, missing information, what happened, or what remains. This distinction applies to natural Portuguese, English, and Spanish phrasing and does not depend on the noun deal versus property.`;
