-- Preserve legacy paid entitlements when users.plan_id is authoritative and no
-- active subscriptions row exists.
...
begin
  ...
  on conflict (user_id, property_id, capability) do nothing returning id into v_entitlement_id;
